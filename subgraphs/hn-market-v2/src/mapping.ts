...
import { HNMarketV2, Buy, Cancel, Sell } from "../generated/HNMarketV2/HNMarketV2"
...
export function handleBuy(event: Buy): void {
  for (let i = 0; i < event.params.hnIds.length; i++) {
    ...
    const hnMarketV2 = HNMarketV2.bind(event.address);
    ...
    buyInfo.feeRatio = hnMarketV2.feeRatio();
